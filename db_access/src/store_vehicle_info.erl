...
init(Req0, Opts) ->
	...
	io:format("What we're passing in: ~p,{~p,~p},~p~n", [Vehicle_id, Lat, Long, Timestamp]),
	package_tracker:store_vehicle_info(package_tracker, {Vehicle_id, {Lat, Long}, Timestamp}),
